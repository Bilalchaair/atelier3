...
//la fonction qui affiche les informations de la personne
     void afficher(){
      ...
      <<"prenom personne: "<<prenom<<endl
      <<"date de naissance:  "<<day<<"/"<<month<<"/"<<year<<endl<<endl;
     }
...
//la fonction qui affiche les informations de l’employé
    void afficher(){
       ...
       <<"prenom employe: "<<prenom<<endl
       <<"date de naissance : "<<day<<"/"<<month<<"/"<<year<<salaire<<" DH"<<endl<<endl;
    }
    friend class chef;
    friend class directeur;
  };
...
//la fonction qui affiche les informations du chef
    void afficher(){
       cout<<"nom chef: "<<nom<<endl
       <<"prenom chef: "<<prenom<<endl
       <<"date de naissance : "<<day<<"/"<<month<<"/"<<year<<endl
       <<"salaire : "<<salaire<<" DH"<<endl<<"service : "<<service<<endl<<endl;
    }
    friend class directeur;
...
//la fonction qui affiche les informations du directeur
    void afficher(){
       cout<<"nom directeur: "<<nom<<endl
       <<"prenom directeur: "<<prenom<<endl
       <<"date de naissance : "<<day<<"/"<<month<<"/"<<year<<endl
       <<"salaire : "<<salaire<<" DH"<<endl<<"service : "<<service<<endl<<"societe: "<<societe<<endl<<endl;
    }
};
  main(){
    personne p1("nom1","prenom1",07,01,2002);
    p1.afficher();
    directeur d1("nom2","nom2",9,8,1980,35000,"sevice1","societe1");
    d1.afficher(); 
  }
